...
const ItemsInput = () => {
  ...
  return (
    <div className="h-full lg:max-w-4xl lg:mx-auto p-0 lg:p-6">
        ...
        <div className="p-4 bg-white border-b border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <input
              ...
              className="w-full px-4 py-4 text-lg border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-gray-50"
              disabled={loading}
            />
            <button
              type="submit"
              disabled={loading || !title.trim()}
              className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-2xl hover:from-blue-600 hover:to-indigo-700 disabled:from-gray-400 disabled:to-gray-400 disabled:cursor-not-allowed transition-all duration-200 font-semibold text-lg shadow-lg"
            >
              {loading ? '✨ Ajout en cours...' : '✨ Ajouter à mes révisions'}
            </button>
          </form>
          ...
          <div className="p-4">
            ...
            {items.length === 0 ? (
              <div className="text-center py-12 px-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Commencez votre parcours !</h3>
                <p className="text-gray-600 text-sm">Ajoutez votre premier élément d'apprentissage ci-dessus</p>
              </div>
            ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center text-white text-sm font-bold">
                            {item.reviewCount + 1}
                          </div>
                          <h4 className="font-semibold text-gray-900 text-base flex-1">{item.title}</h4>
                        </div>
                      ...
                      <button
                        ...
                        className="ml-3 p-3 text-red-500 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200"
